    ...
    <nav class="main-header navbar navbar-expand navbar-dark  ">
      ...
      <ul class="navbar-nav">
        ...
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a accesskey="1" href="../../pages/categorias/categoria-list.php" class="nav-link">Categorias</a>
        </li>
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a accesskey="2" href="../../pages/produtos/produto-list.php" class="nav-link">Produtos</a>
        </li>
        ...
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a href="../../pages/vendas/despesa-list.php" class="nav-link">Minhas Despesas</a>
        </li>
        ...
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a href="../../pages/fornecedor/fornecedor-list.php" class="nav-link">Fornecedor</a>
        </li>
        ...
        <li class="<?php
                    ...
                    ?>" style="display: none;">
          <a accesskey="i" href="../../pages/xml/xml-list.php" class="nav-link">
            <p>Importar XML</p>
          </a>
        </li>
